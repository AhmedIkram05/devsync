...
@patch(
    "backend.src.api.controllers.admin_controller.settings_service.get_settings",
    return_value={"default_user_role": "developer"},
)
...
def test_update_system_settings_success(
    mock_validate, mock_identity, mock_update_settings, mock_audit_record, mock_emit, app
):
...
@patch("backend.src.api.controllers.admin_controller.validate_system_settings", return_value=None)
def test_update_system_settings_success_with_scalar_identity(
    mock_validate, mock_identity, mock_update_settings, mock_audit_record, mock_emit, app
):
