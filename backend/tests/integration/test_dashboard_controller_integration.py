...
class TestDashboardControllerIntegration:
    ...
    def test_user_dashboard_task_counts(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_user_dashboard_task_status_breakdown(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_user_dashboard_due_soon_tasks(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_admin_dashboard_role_breakdown(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_admin_dashboard_completed_status_handling(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_project_dashboard_task_breakdown(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_admin_dashboard_zero_data(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
    ...
    @patch("src.api.controllers.dashboard_controller.get_jwt")
    @patch("src.api.controllers.dashboard_controller.get_jwt_identity")
    def test_user_dashboard_no_tasks(
        self, mock_jwt_id, mock_jwt, mock_user, mock_project, mock_task, mock_jsonify, app
    ):
